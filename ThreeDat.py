...
#################################################################
	ax0.plot(k00/100, Rm, label=r'$\rm R_{TM \ %s \ nm}$' %dirks[i], color=litecols[i], linewidth = 4)
...
for z in range (0, 5):   
	...
	ax0.plot(k_data, R_exp, 'o', label=r'$\rm R_{Exp \ %s \ nm}$' %dirks[z], markersize=10, markeredgecolor = "black", linewidth = 5, markerfacecolor = litecols[z])

ax0.legend(loc='center right', fontsize='15', ncol = 3)
plt.savefig("dSweep3Data.png")
