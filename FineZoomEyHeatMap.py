...
for k in range(0,28):
	...
	plt.savefig("EyMaps/PDF/Ey2.22XSecHM%.2f_%.2f_3_7Mag.pdf" %(base, lam))
	plt.savefig("EyMaps/PNG/Ey2.22XSecHM%.2f_%.2f_3_7Mag.png" %(base, lam))
#abs(Full*(dt/T))
