...
plt.scatter(AgTra[0:numPlots], TraTroughLam, linewidth = 2, s=55,edgecolors = 'white', c='red', label = "Plasmon")       
...
plt.savefig("HMFullDevTraMinWNWGreenDots_1100_1800Y.pdf")
plt.savefig("HMFullDevTraMinWNWGreenDots_1100_1800Y.png")
###############################################################################
...
plt.scatter(AgAbs[0:numPlots], peak2,  linewidth = 5, s=80,edgecolors = 'black', c='blue')       

plt.scatter(AgAbs[0:numPlots], peak2,  linewidth = 2, s=65,edgecolors = 'white', c='darkgreen')       

plt.scatter(AgAbs[0:numPlots], peak, linewidth = 5, s=80,edgecolors = 'black', c='red')       

plt.scatter(AgAbs[0:numPlots], peak, linewidth = 2, s=65,edgecolors = 'white', c='maroon')       
...
plt.savefig("Abs_RasterHMFull.pdf")
plt.savefig("Abs_RasterHMFull.png")
