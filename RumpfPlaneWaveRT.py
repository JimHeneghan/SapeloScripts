...
freq   = np.loadtxt("hBNDrDStructfreq.txt",  usecols=(0), skiprows= 1, unpack =True)

ExR    = np.loadtxt("hBNDrDStructExRef.txt", usecols=(0), skiprows= 1, unpack =True)
ExI    = np.loadtxt("hBNDrDStructExRef.txt", usecols=(1), skiprows= 1, unpack =True)

EyR    = np.loadtxt("hBNDrDStructEyRef.txt", usecols=(0), skiprows= 1, unpack =True)
EyI    = np.loadtxt("hBNDrDStructEyRef.txt", usecols=(1), skiprows= 1, unpack =True)

EzR    = np.loadtxt("hBNDrDStructEzRef.txt", usecols=(0), skiprows= 1, unpack =True)
EzI    = np.loadtxt("hBNDrDStructEzRef.txt", usecols=(1), skiprows= 1, unpack =True)

ExTR   = np.loadtxt("hBNDrDStructExTra.txt", usecols=(0), skiprows= 1, unpack =True)
ExTI   = np.loadtxt("hBNDrDStructExTra.txt", usecols=(1), skiprows= 1, unpack =True)

EyTR   = np.loadtxt("hBNDrDStructEyTra.txt", usecols=(0), skiprows= 1, unpack =True)
EyTI   = np.loadtxt("hBNDrDStructEyTra.txt", usecols=(1), skiprows= 1, unpack =True)

EzTR   = np.loadtxt("hBNDrDStructEzTra.txt", usecols=(0), skiprows= 1, unpack =True)
EzTI   = np.loadtxt("hBNDrDStructEzTra.txt", usecols=(1), skiprows= 1, unpack =True)

ExIncR = np.loadtxt("hBNDrDStructExInc.txt", usecols=(0), skiprows= 1, unpack =True)
ExIncI = np.loadtxt("hBNDrDStructExInc.txt", usecols=(1), skiprows= 1, unpack =True)

EyIncR = np.loadtxt("hBNDrDStructEyInc.txt", usecols=(0), skiprows= 1, unpack =True)
EyIncI = np.loadtxt("hBNDrDStructEyInc.txt", usecols=(1), skiprows= 1, unpack =True)

EzIncR = np.loadtxt("hBNDrDStructEzInc.txt", usecols=(0), skiprows= 1, unpack =True)
EzIncI = np.loadtxt("hBNDrDStructEzInc.txt", usecols=(1), skiprows= 1 , unpack =True)
...
plt.plot((c0/freq)*1e6, ((REF+TRA)), label = r'$\rm R+T_{FDTD \ Ag Pattern \ Toy \ nm^{3}}$', color = "limegreen", linewidth = 2)
...
plt.savefig("Spec_hBNDrDStruct_0_10RTADrDStructRandT.pdf")
plt.savefig("Spec_hBNDrDStruct_0_10RTADrDStructRandT.png")
