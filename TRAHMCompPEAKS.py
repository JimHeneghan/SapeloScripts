...
TraPeakLam  = np.zeros(numPlots, dtype = np.double)
TraPeak     = np.zeros(numPlots, dtype = np.double)
...
plt.scatter(AgTra[0:numPlots], TraPeakLam2,  linewidth = 5, s=115,edgecolors = 'black', c='blue', label = "Polariton")       

plt.scatter(AgTra[0:numPlots], TraPeakLam2,  linewidth = 2, marker = "X", s=85,edgecolors = 'white', c='blue', label = "Polariton")       

plt.scatter(AgTra[0:numPlots], TraPeakLam, linewidth = 5, s =115,edgecolors = 'black', c='red', label = "Plasmon")       

plt.scatter(AgTra[0:numPlots], TraPeakLam, linewidth = 2 ,marker = "P", s =85,edgecolors = 'white', c='red', label = "Plasmon")       
...
plt.savefig("HM_Tra_Raster_Full_Peaks.pdf")
plt.savefig("HM_Tra_Raster_Full_Peaks.png")
###############################################################################
...
plt.scatter(AgAbs[0:numPlots], peak2,  linewidth = 5, s=75,edgecolors = 'black', c='blue', label = "Polariton")       

plt.scatter(AgAbs[0:numPlots], peak2,  linewidth = 2, s=55,edgecolors = 'white', c='blue', label = "Polariton")       

# plt.scatter(AgAbs[0:numPlots], peak, "H", linewidth = 5, s=75,edgecolors = 'black', c='red', label = "Plasmon")       

# plt.scatter(AgAbs[0:numPlots], peak, "H", linewidth = 2, s=55,edgecolors = 'white', c='red', label = "Plasmon")       
