...
TRA2_24um  = np.loadtxt("2_24/Ref/2_24umPitchRTA.txt",  usecols=(2), skiprows= 1, unpack =True)

###########################################################################
# REF2_281um = np.loadtxt("2_281um/Ref/2_281umPitchRTA.txt",  usecols=(1), skiprows= 1, unpack =True)

###########################################################################
REF2_30um = np.loadtxt("3Term/2_30um/Ref/2_30umPitchRTA.txt",  usecols=(1), skiprows= 1, unpack =True)
A2_30um   = np.loadtxt("3Term/2_30um/Ref/2_30umPitchRTA.txt",  usecols=(3), skiprows= 1, unpack =True)
TRA2_30um = np.loadtxt("3Term/2_30um/Ref/2_30umPitchRTA.txt",  usecols=(2), skiprows= 1, unpack =True)
...
TRA2_36um = np.loadtxt("2_36um/Ref/2_36umPitchRTA.txt",  usecols=(2), skiprows= 1, unpack =True)
...
###########################################################################
REF2_44um = np.loadtxt("3Term/2_44um/Ref/2_44umPitchRTA.txt",  usecols=(1), skiprows= 1, unpack =True)
A2_44um   = np.loadtxt("3Term/2_44um/Ref/2_44umPitchRTA.txt",  usecols=(3), skiprows= 1, unpack =True)
TRA2_44um = np.loadtxt("3Term/2_44um/Ref/2_44umPitchRTA.txt",  usecols=(2), skiprows= 1, unpack =True)
...
TRA2_48um = np.loadtxt("2_48um/Ref/2_48umPitchRTA.txt",  usecols=(2), skiprows= 1, unpack =True)
...
TRA2_51um = np.loadtxt("2_51um/Ref/2_51umPitchRTA.txt",  usecols=(2), skiprows= 1, unpack =True)
...
plt.plot(lam, REF2_30um, '--',label = r'$\rm R_{Pitch = \ 2.30 \ \mu m \ DD}$', color = "red", linewidth = 6)
plt.plot(lam, TRA2_30um, '--',label = r'$\rm T_{Pitch = \ 2.30 \ \mu m \ DD}$', color = "red", linewidth = 6)
...
plt.plot(lam, REF2_42um, label = r'$\rm R_{Pitch = \ 2.42 \ \mu m}$', color = "deepskyblue", linewidth = 3)
plt.plot(lam, TRA2_42um, label = r'$\rm T_{Pitch = \ 2.42 \ \mu m}$', color = "deepskyblue", linewidth = 3)

plt.plot(lam, REF2_44um, '--',label = r'$\rm R_{Pitch = \ 2.44 \ \mu m \ DD}$', color = "blue", linewidth = 6)
plt.plot(lam, TRA2_44um, '--',label = r'$\rm T_{Pitch = \ 2.44 \ \mu m \ DD}$', color = "blue", linewidth = 6)

plt.plot(lam, REF2_48um, label = r'$\rm R_{Pitch = \ 2.48 \ \mu m}$', color = "navy", linewidth = 3)
plt.plot(lam, TRA2_48um, label = r'$\rm T_{Pitch = \ 2.48 \ \mu m}$', color = "navy", linewidth = 3)

plt.plot(lam, REF2_51um, label = r'$\rm R_{Pitch = \ 2.51 \ \mu m}$', color = "purple", linewidth = 3)
plt.plot(lam, TRA2_51um, label = r'$\rm T_{Pitch = \ 2.51 \ \mu m}$', color = "purple", linewidth = 3)
...
plt.savefig("AgSiPitchSweepModelMixR.png")
plt.clf()
...
# ax.axvline(x =0.1, color = 'black')
# plt.savefig("XFAGFilmOnSiDrD3x3Sweep.pdf")
plt.savefig("AgSiPitchSweepModelMixR5_9.png")
...
plt.plot(lam, A2_30um,'--', label = r'$\rm A_{Pitch = \ 2.30 \ \mu m \ DD}$', color = "red", linewidth = 6)
...
plt.plot(lam, A2_44um,'--', label = r'$\rm A_{Pitch = \ 2.44 \ \mu m \ DD}$', color = "blue", linewidth = 6)
...
# plt.savefig("XFAGFilmOnSiDrD3x3Sweep.pdf")
plt.savefig("AgSiPitchSweepModelMix_A_5_9.png")
