...
lam, n, k= np.loadtxt("PalikAg.txt", usecols=(1,2,3), skiprows= 187, unpack =True )
...
# lam[0:(len(lam)-3)] =lam[0:(len(lam)-3)] 
n1 = n - 1j*k
d = 20e-9
imp0 = 376.730313
inc = math.pi*0/180.0
...
plt.savefig("AgPalikDrudeFit_SiO2.pdf")
plt.savefig("AgPalikDrudeFit_SiO2.png")
